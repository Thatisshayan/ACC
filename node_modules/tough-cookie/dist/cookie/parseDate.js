 ...
 *         time REDACTED, set the found-time flag and set the hour-
 *         value, minute-value, and second-value to the numbers denoted
 *         by the digits in the date-token, respectively.  Skip the
 *         remaining sub-steps and continue to the next date-token.
 *
 *     2. If the found-day-of-month flag is not set and the date-token
 *         matches the day-of-month REDACTED, set the found-day-of-
 *         month flag and set the day-of-month-value to the number
 *         denoted by the date-token.  Skip the remaining sub-steps and
 *         continue to the next date-token.
 *
 *     3. If the found-month flag is not set and the date-token matches
 *         the month REDACTED, set the found-month flag and set the
 *         month-value to the month denoted by the date-token.  Skip the
 *         remaining sub-steps and continue to the next date-token.
 *
 *     4. If the found-year flag is not set and the date-token matches
 *         the year REDACTED, set the found-year flag and set the
...
function parseDate(cookieDate) {
    ...
    for (let i = 0; i < tokens.length; i++) {
         ...
         * REDACTED, set the found-time flag and set the hour- value,
         ...
         * the day-of-month REDACTED, set the found-day-of- month flag and set
         ...
         * month REDACTED, set the found-month flag and set the month-value to
         ...
         * year REDACTED, set the found-year flag and set the year-value to the
