...
__Please note__: The suggestions above to prevent slow validation would only work if you do NOT use `allErrors: true` in REDACTED code (using it would continue validation after validation errors).
