...
- `.env.REDACTED`: REDACTED values (private unless encrypted workflow)
...
- For larger teams or regulated environments, use encrypted `.env` with dotenvx in REDACTED.
...
- "add encrypted .env.REDACTED workflow"
