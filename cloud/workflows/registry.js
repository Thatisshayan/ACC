...
function listWorkflows() {
  const workflows = [
    ...
    ...scanCrewaiProjects(),
    {
      key: 'acc:social_publish_pipeline',
      kind: 'publishing_pipeline',
      id: 'acc_social_publish_pipeline',
      slug: 'acc-social-publish-pipeline',
      name: 'ACC Social Publish Pipeline',
      category: 'Publishing',
      description: 'Generate a social draft with Alphonso, review it in ACC, then publish with SocialClaw.',
      user_command: 'publish social content through alphonso and socialclaw',
      command: 'workflow: acc:social_publish_pipeline',
      source_path: path.join(WORKFLOWS_ROOT, 'synthetic', 'acc_social_publish_pipeline'),
      source_dir: path.join(WORKFLOWS_ROOT, 'synthetic'),
      approval_required_for: ['publish to social media'],
      final_outputs: ['approved social draft', 'published social post'],
      lanes: ['plan', 'draft', 'review', 'publish'],
      aliases: collectAliases({
        id: 'acc_social_publish_pipeline',
        key: 'acc:social_publish_pipeline',
        name: 'ACC Social Publish Pipeline',
        ...
        aliases: [
          ...
          'publish via alphonso and socialclaw',
          'alphonso to socialclaw',
          'generate then publish social',
