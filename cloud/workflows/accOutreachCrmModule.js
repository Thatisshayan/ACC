...
const { ClickUpConnector } = require('../connectors/clickup.js');

const clickup = new ClickUpConnector();
...
async function mirrorLeadToClickUp(lead, listIdOverride) {
  ...
  if (!clickup.ok() || !listId) return { status: 'skipped', reason: 'clickup_disabled_or_missing_list' };
